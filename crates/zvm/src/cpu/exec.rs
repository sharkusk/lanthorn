...
///
/// Source: Bocfel interpreter (garglk/terps/bocfel/unicode.cpp, function
/// `build_zscii_to_character_graphics_table`) — MIT licence (Chris Spiegel,
/// 2009–2025), read 2026-09-09. Faithfully implements the 8×8 bitmap descriptions
/// in Z-Machine Standards Document §16.
