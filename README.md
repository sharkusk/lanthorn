...
* **Scott Adams** — *Next release:* the TI-99/4A and Commodore 64 releases too,
  ...
  it finds the game inside the 48K memory dump, names the release, and plays it
  in the wording that release was written for. The Commodore 64 Mysterious
  Adventures show their pictures, redrawn at the size your terminal shows them
  rather than stretched from the original's tiny canvas
